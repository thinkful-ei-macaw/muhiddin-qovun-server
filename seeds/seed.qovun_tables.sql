BEGIN;
  ...
  INSERT INTO posts
    (title, content, section, user_name)
  VALUES
    ('Full Stack Web Developer', 'We are looking for a full stack web developer who has 1+ years of 
  job experience in ReactJS, PostgreSQL, Express and NodeJS. Contact us at https://www.thinkful.com', 'Jobs', 'user'),
    ('Front End Engineer', 'Uber HQ is hiring for Front End Developer role who has at least 6 months of
  experience in ReactJS and NodeJS. Contact us at 415-555-5555 for more detail', 'Jobs', 'john'),
    ('1 bedroom apartment in Marina district', '1-bed-apt in Marina dis. available Apr 1st, Call 415-999-9999', 'Apartments', 'user'),
    ('A studio in Financial District', 'A studio available on Apr 5 in FiDi, email: someone@example.com', 'Apartments', 'john'),
    ('2020 BMW m3 $40k', '2020 bmw m3 for sale in SF. $40k final. For details call me at 415-333-3333', 'Cars', 'user'),
    ('2016 Toyota Camry $30k', '2016 Toyota Camry Hybrid for sale in Oakland. Price: $20,600. For details text me at 415-333-3333', 'Cars', 'user'),
    ('Free TV', 'Free samsung smart tv 55 - 4k tv. Call 415-333-3333, if interested', 'Other', 'john'),
    ('One master bedroom for rent', 'Master bedroom available in Outer Richmond on May 1st. $1000 deposit plus first
and last month, total: $2,600', 'Other', 'john'),
...
- One car parking spot (additional $300/month)', 'Apartments', 'john'),
    ('Uzbek Food Festival[Central Asian Food Festival]', 'On 7/18/2020 Uzbek Food Festival is planned to be held in Chicago, IL.', 'Events', 'user'),
    ('Nowruz Holiday Celebration', 'Navruz 2019 and UCC opening Celebration, March 25 2019', 'Events', 'john');
